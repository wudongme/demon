...
public class ZonedTimestamp {
	...
	private static final ZoneId TIMESTAMP_ZONE_ID = ZoneId.systemDefault();
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link LocalDateTime}, {@link LocalDate},
    ...
    public static String toIsoString(ZonedDateTime timestamp, TemporalAdjuster adjuster) {
		...
		LocalDateTime localDateTime = timestamp.withZoneSameInstant(TIMESTAMP_ZONE_ID).toLocalDateTime();

		return TIMESTAMP_FORMATTER.format(localDateTime).replaceAll("T", " ");
    }
